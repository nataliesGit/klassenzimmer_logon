...
$Form4 = GUICreate("Anzeige Datenbank-Inhalt", 500, 465, 367, 194)
GUISetIcon("ico\list.ico", -1)
$Edit1 = GUICtrlCreateEdit("", 40, 0, 400, 457)
GUICtrlSetData(-1, "---")
GUISetState(@SW_SHOW)
	...
	Local $aResult, $iRows, $iColumns, $iRval
	  _SQLite_Startup()
	   ...
	   If @error Then
		  ...
		  Exit -1
	   EndIf
	$iRval = _SQLite_GetTable2d ($pcdb, "select Rechner,Raum,IP,VLAN,Status from raumpc order by Raum;", $aResult, $iRows, $iColumns)
